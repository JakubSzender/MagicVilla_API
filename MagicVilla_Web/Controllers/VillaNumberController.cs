...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNoId)
        {
            var response = await _villaNumberService.GetAsync<APIResponse>(villaNoId);
            if(response!= null && response.IsSuccess) 
            {
        ...
        public async Task<IActionResult> DeleteVillaNumber(int villaNoId)
        {
            var response = await _villaNumberService.GetAsync<APIResponse>(villaNoId);
            if (response != null && response.IsSuccess)
            {
